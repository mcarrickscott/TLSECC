...
use tlsecc::nist384::BYTES;
use tlsecc::nist384::KEY_PAIR;
use tlsecc::nist384::PREHASH;
use tlsecc::nist384::SIGN;
use tlsecc::nist384::VERIFY;
...
fn main() {
    ...
    const RAN:&str="94a1bbb14b906a61a280f245f9e93c7f3b4a6247824f5d33b9670787642a68deb9670787642a68deabababababababababababababababab";
