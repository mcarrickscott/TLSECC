...
// Then copy https://github.com/C2SP/wycheproof/blob/master/testvectors/ecdsa_secp384r1_sha384_p1363_test.json into the work directory
// Move to the work directory and process the test vectors into a form digestible by simple C code
//
// python3 parse.py ecdsa_secp384r1_sha384_p1363_test.json > tvs384.txt
//
...
{       
    ...
    while(fgets(buff, 4096, fp)) {
	    ...
	    res=NIST384_VERIFY(pub,lenm,m,sig);
