...
// Then copy https://github.com/C2SP/wycheproof/blob/master/testvectors/ecdh_secp521r1_ecpoint_test.json into the work directory
// Move to the work directory and process the test vectors into a form digestible by simple C code
//
// python3 parsex.py ecdh_secp521r1_ecpoint_test.json > tvx521.txt
//
// Finally compile and run
//
// gcc -O2 testx521.c s521.c nist521.c hash.c -o testx521
//
...
int main()
{
    ...
    while(fgets(buff, 512, fp)!=NULL) {
    	...
    	res=NIST521_SHARED_SECRET(priv,pub,mysh);
    	
    	if (fgets(buff,512,fp)==NULL) break;  // get wycheproof result
    	len=process(buff);
