...
pub fn NIST521_KEY_PAIR(compress: bool,prv: &[u8],public: &mut [u8]) {
    let mut P=ECP::new();
...
pub fn NIST521_SIGN(prv: &[u8],ran: &[u8],m:&[u8],sig: &mut [u8]) {
...
pub fn NIST521_VERIFY(public: &[u8],m:&[u8],sig:&[u8]) -> bool {
    let mut G=ECP::new();
    let mut Q=ECP::new();
